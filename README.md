...
- **Web App** — профиль (серия, рекорд, пропуски, штрафы, статус), личные уведомления, рейтинг, правила.
- **Админка** (внутри Web App, для пользователей с правами) — редактирование всех настроек:
  ...
  участники, лента последних событий участников с ручными правками статусов, запуск отчёта.
