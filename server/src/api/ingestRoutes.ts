 ...
 * и маршрут, а выгрузка метрик со всеми галочками весит 15 МБ и больше (один пульс —
 * десятки тысяч точек). Стандартного мегабайта Fastify не хватает — запрос отбивался бы с 413.
 */
const HUB_BODY_LIMIT = 50 * 1024 * 1024;
