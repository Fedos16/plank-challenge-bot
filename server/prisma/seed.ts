...
2. Данные приходят с умных весов: openScale на телефоне пересылает их в приложение
3. История веса личная: другие участники видят только имя, но не ваши цифры
4. Участники нужны для одного — если весы и телефон общие, владелец телефона указывает,
   кому какой профиль весов принадлежит`;
